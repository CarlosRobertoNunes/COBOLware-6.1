       ...
       DATE-WRITTEN.  13/06/2021 00:46:15 00:46:16.
       SECURITY.      *************************************************
                      *************************************************
                      *                                          HOST *
      ...
      *
       01  WS-VARIAVEIS.
           03 TRACOS                         PIC  X(108)    VALUE
              ALL '-'.
           03 PGMID                          PIC  X(008)    VALUE
              '#CARTAO.'.
      ...
      *
       RT-CANCELARX.                               EXIT.
      *----------------------------------------------------------------*
      *            ROTINA DE FINALIZACAO DO PROGRAMA CARTAO            *
      *----------------------------------------------------------------*
