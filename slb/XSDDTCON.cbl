      ...
      *    05 GRWEEK-DATA            PIC  9(006) VALUE ZERO.
      *    05 REDEFINES GRWEEK-DATA.
      *       10 DM-WEEK             PIC  9(004).
      *       10                     PIC  X(002).
      *    05 REDEFINES GRWEEK-DATA.
      *       15 DD-WEEK             PIC  9(002).
      *       15 MM-WEEK             PIC  9(002).
      *       15 AA-WEEK             PIC  9(002).
      *    05 V-WEEK-5               PIC  9(005) VALUE ZERO.
      *    05 REDEFINES V-WEEK-5.
      *       10 V-WEEK-3            PIC  9(003).
      *       10 FILLER              PIC  9(002).
      *    05 VALUE '255136140250'.
      *       10 INC-WEEK            PIC  9(001) OCCURS 12.
      *    05 TAB-NM-WEEK.
      ...
      *       10 NM-WEEK             PIC  X(007) OCCURS 6.
      *    05 GRWEEK-DIA             PIC  9(001) VALUE ZERO.
