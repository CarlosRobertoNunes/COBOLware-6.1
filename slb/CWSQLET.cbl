      ...
      $Set LinkCount(128)
       ...
       01  SQLFPN GLOBAL.
           02  SQLFPN-FILE-LEN PIC S9(4) COMP-5 VALUE +26.
           02  SQLFPN-FILENAME PIC X(26) VALUE "G:\cobware\slb\CWSQLET.p
      -    "co".

       01  SQLCTX GLOBAL PIC S9(9) COMP-5 VALUE +1401297318.
       ...
       01  SQLEXD GLOBAL.
           ...
           02  SQL-SQHSTV   PIC S9(9) COMP-5 OCCURS 1 TIMES.
           02  SQL-SQHSTL   PIC S9(9) COMP-5 OCCURS 1 TIMES.
           02  SQL-SQHSTS   PIC S9(9) COMP-5 OCCURS 1 TIMES.
           02  SQL-SQINDV   PIC S9(9) COMP-5 OCCURS 1 TIMES.
           02  SQL-SQINDS   PIC S9(9) COMP-5 OCCURS 1 TIMES.
           02  SQL-SQHARM   PIC S9(9) COMP-5 OCCURS 1 TIMES.
           02  SQL-SQHARC   PIC S9(9) COMP-5 OCCURS 1 TIMES.
      ...
      *    EXEC SQL INCLUDE SQLCA END-EXEC.
       ...
       000-INICIO.
           ...
           DISPLAY "AUTOMATIC" UPON ENVIRONMENT-VALUE
