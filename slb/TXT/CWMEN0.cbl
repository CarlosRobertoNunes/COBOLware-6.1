...
Joadir     05 IZ                       PIC  9(002) VALUE 0.
      ...
      *    05 SIZE-SCREEN              PIC  9(004) VALUE 2000.
       ...
       01  AREAS-DE-TRABALHO-2.
           05 MSG-1 PIC X(12) VALUE "Configuraá∆o".
           ...
           "Opá∆o     PgUp  PgDn  F1-Help  F3-Config  F5-Spool         E
      -        "sc-Sa°da ".
           05 M1-OFF                   PIC  X(070) VALUE
           "Opá∆o     PgUp  PgDn  F1-Help  F3-Config                   E
      -        "sc-Sa°da ".
           05 M2                       PIC  X(070) VALUE
           "Opá∆o     PgUp  PgDn  F1-Menu                              E
      -        "sc-Sa°da ".

       01  AREAS-DE-TRABALHO-3.
           05 M1-MOUSE                 PIC  X(070) VALUE
           "         ööööööõõõõõõfffffffffhhhhhhhhhhhjjjjjjjjjj      nee
      -        "eeeeeeeee ".
           05 M1-MOUSE-OFF             PIC  X(070) VALUE
           "         ööööööõõõõõõfffffffffhhhhhhhhhhh                 ee
      -        "eeeeeeeee ".
           05 M2-MOUSE                 PIC  X(070) VALUE
           "         ööööööõõõõõõfffffffff                            ee
      -        "eeeeeeeee ".
      ...
      *
       ...
       110-ACCEPT-TELA.
           ...
           ELSE
                ...
                MOVE "öööööö" TO RODAPE-MOUSE (10: 6)
           END-IF
           ...
           ELSE
                ...
                MOVE "õõõõõõ" TO RODAPE-MOUSE (16: 6)
           END-IF
