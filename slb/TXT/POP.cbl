...
Frango*       10 BOX-LINE              PIC  X(80) OCCURS 25.
      ...
      *    05 TXT-MAP                  PIC X(2000) VALUE SPACES.
           ...
           05 ER-OBJETOS.
              ...
              10 LB-OBJETOS            PIC  X(050) VALUE "cwuser1.".
           05 ER-HOTS.
              10 FS-HOTS               PIC  X(002) VALUE "00".
              10 LB-HOTS               PIC  X(050) VALUE "cwuser7.".
           05 ER-GUIA.
              10 FS-GUIA               PIC  X(002) VALUE "00".
              10 LB-GUIA               PIC  X(050) VALUE "cwuser2.".
           05 ER-GUIA-O.
              10 FS-GUIA-O             PIC  X(002) VALUE "00".
              10 LB-GUIA-O             PIC  X(050) VALUE "cwuser9.".
           05 ER-HIDE.
              10 FS-HIDE               PIC  X(002) VALUE "00".
              10 LB-HIDE               PIC  X(050) VALUE "cwuser3.".
           05 ER-CRITICA.
              10 FS-CRITICA            PIC  X(002) VALUE "00".
              10 LB-CRITICA            PIC  X(050) VALUE "cwuser4.".
           05 ER-USINGS.
              10 FS-USINGS             PIC  X(002) VALUE "00".
              10 LB-USINGS             PIC  X(050) VALUE "cwuser5.".
           05 ER-BUTTONS.
              10 FS-BUTTONS            PIC  X(002) VALUE "00".
              10 LB-BUTTONS            PIC  X(050) VALUE "cwuser6.".
           05 ER-SAVEATTR.
              10 FS-SAVEATTR           PIC  X(002) VALUE "00".
              10 LB-SAVEATTR           PIC  X(050) VALUE "cwuser8.".
           05 ER-WORKBOX.
              10 FS-WORKBOX            PIC  X(002) VALUE "00".
              10 LB-WORKBOX            PIC  X(050) VALUE "cwwbox.".
           05 ER-WINWORK.
              10 FS-WINWORK            PIC  X(002) VALUE "00".
              10 LB-WINWORK            PIC  X(050) VALUE "cwwin1".
           05 ER-THUMBS.
              10 FS-THUMBS             PIC  X(002) VALUE "00".
              10 LB-THUMBS             PIC  X(050) VALUE "cwwin3".
      ...
      *          282 283 284 251 285 286 287 288 289 290.
       ...
       COPY CONSOLE.
       01  LEN-PROGRAMA     COMP-5 PIC S9(004)  VALUE 0.
       01  DP                      PIC X(001)   VALUE SPACE.
...
CEDAE                   MOVE '00' TO JANPOS
      ...
      *              MOVE 0 TO AVANCO-PENDENTE
                ...
                OR FUN-ACCEPT
                   IF PROGRAMA(9:1) = "." OR ","
                      MOVE 8             TO LEN-PROGRAMA
                      MOVE PROGRAMA(9:1) TO DP
                   ELSE
                      PERFORM VARYING LEN-PROGRAMA FROM 9 BY 1
                              UNTIL LEN-PROGRAMA > LENGTH PROGRAMA
                              OR  PROGRAMA(LEN-PROGRAMA:1) = '.' OR ','
                                  CONTINUE
                      END-PERFORM
                      MOVE PROGRAMA(LEN-PROGRAMA:1) TO DP
                      IF  (DP NOT = '.')
                      AND (DP NOT = ',')
                          EXEC COBOLware Send
                         Message "Nome do programa excede 80 caracteres"
                          END-EXEC
                      END-IF
                      SUBTRACT 1 FROM LEN-PROGRAMA
                   END-IF
                END-IF
                IF  X91-PARAMETER < 2
                    GOBACK
           ...
           IF PROGRAMA(1:LEN-PROGRAMA) = 'CWBOXD'
           ...
           AND CWOBJE-COMBO-BOX
               ...
               EVALUATE TRUE
                   WHEN EDIT-F1
                     OR EDIT-ALT-H
                        IF  LEN-PROGRAMA = 8
                            MOVE PROGRAMA(1:8) TO CONTEXT-ID
                            MOVE DATANAME-E    TO CONTEXT-ID(09:)
                        ELSE
                            MOVE SPACES TO CONTEXT-ID
                            STRING PROGRAMA(1:LEN-PROGRAMA)
                                   DELIMITED BY SIZE
                                   DATANAME-E
                                   DELIMITED BY SPACE
                                   INTO CONTEXT-ID
